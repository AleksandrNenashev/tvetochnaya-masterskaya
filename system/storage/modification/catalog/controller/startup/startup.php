...
class ControllerStartupStartup extends Controller {
	public function index() {
		...
		// Light Checkout
			$this->config->set('light_empty_cart', $this->cart->getProducts());
			if (class_exists('Light\Replaceurl')) {
				$this->url->addRewrite(new Light\Replaceurl($this->config));
			}
			if (class_exists('Light\Lightcheckout')) {
				$this->registry->set('light', new Light\Lightcheckout($this->registry));
			}
